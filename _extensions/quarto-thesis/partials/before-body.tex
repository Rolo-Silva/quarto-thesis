...
\textsc{\Large Upgrade Report}\\[0.5cm] % Thesis type
...
\vfill
 ...
 \large \textit{ A report submitted in fulfillment of the requirements for upgrading to\\ candidate status for the degree of \degreename}\\[0.3cm] % University requirement text
%\large \textit{An upgrade report submitted in fulfillment of the requirements\\ for the degree of }\\[0.3cm] % University requirement text
\textit{in the}\\[0.4cm]
%\groupname\\
